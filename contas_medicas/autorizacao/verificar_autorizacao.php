...
unset($_SESSION['dadosAutorizacao']);
...
$sql = "SELECT char_22, cd_prestador_principal, cd_transacao, nr_serie_doc_original, nr_doc_original, nr_perref, 
...
if (empty($data)) {
    $_SESSION['erroAutorizacao'] = "Dados não encontrados";
    header("Location: ../../dashboard.php");
    exit;
} else {
    unset($_SESSION['erroAutorizacao']); // Limpa sessão

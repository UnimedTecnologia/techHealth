...
//* UPDATE SQL
$sql = "UPDATE gp.DOCRECON SET CD_UNIDADE_CARTEIRA = :codUnidade, CD_CARTEIRA_USUARIO = :carteira, CHAR_22 = :modalChar22 
WHERE CD_PRESTADOR_PRINCIPAL = :prestadorPrincipal and DT_ANOREF = :anoRef and NR_PERREF = :periodoRef and NR_DOC_ORIGINAL = :nrDocOrig ";

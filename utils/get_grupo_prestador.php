...
require_once "../config/AW00MD.php";
    ...
    try {
        ...
        $sql = "select distinct p.cd_grupo_prestador, g.ds_grupo_prestador from gp.preserv p 
                inner join gp.gruppres g on p.cd_grupo_prestador = g.cd_grupo_prestador 
                where p.cd_unidade = 540 
        ...
        if ($result) {
            ...
            if (!empty($data)) {
                ...
                $response = [
                    'error' => true,
                    'message' => 'Grupo de Prestadores não encontrados',
                    'data' => []
                ];

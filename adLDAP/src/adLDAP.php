...
class adLDAP {
    ...
    * @var string
    */   
	//protected $accountSuffix = "@staelisa.local";
	protected $accountSuffix = "@uni540.local";
    ...
    * @var string
    */
	//protected $baseDn = "DC=staelisa,DC=local";
	protected $baseDn = "DC=uni540,DC=local"; 
    ...
    * @var array
    */
    protected $domainControllers = array("192.168.0.22");
